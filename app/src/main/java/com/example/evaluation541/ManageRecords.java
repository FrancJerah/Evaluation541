...
public class ManageRecords extends AppCompatActivity {
    ...
    private static String urlHost = "http://192.168.254.102/ancuin2/SelectItemDetails.php";
    private static String urlHostDelete = "http://192.168.254.102/ancuin2/delete.php";
    private static String urlHostGender = "http://192.168.254.102/ancuin2/selectGender.php";
    private static String urlHostCivilStatus = "http://192.168.254.102/ancuin2/selectCivilStatus.php";
    private static String urlHostID = "http://192.168.254.102/ancuin2/selectid.php";
